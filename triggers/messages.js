...
const messages_hidden = require("./messages_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (messages.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (messages.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  display: {
    label: "messages",
    description: "Triggers when a messages Blockchain event is initiated.",
  },
