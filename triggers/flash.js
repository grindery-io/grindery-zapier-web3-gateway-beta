...
const flash_hidden = require("./flash_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (flash.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (flash.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  display: {
    label: "flash",
    description: "Triggers when a flash Blockchain event is initiated.",
  },
