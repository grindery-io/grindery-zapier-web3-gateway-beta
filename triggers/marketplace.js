...
const marketplace_hidden = require("./marketplace_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (marketplace.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (marketplace.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  key: "marketplace",
  noun: "Marketplace Token",

  display: {
    label: "marketplace",
    description: "Triggers when a marketplace Blockchain event is initiated.",
  },
  ...
  operation: {
    ...
    inputFields: [
      ...
      },
      {
        ...
        dynamic: "marketplace_hidden.key",
      },
