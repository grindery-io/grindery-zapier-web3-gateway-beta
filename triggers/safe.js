...
const safe_hidden = require("./safe_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (safe.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (safe.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  display: {
    label: "Safe",
    description: "Triggers when a Safe Blockchain event is initiated.",
  },
