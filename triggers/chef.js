...
const chef_hidden = require("./chef_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (chef.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (chef.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  display: {
    label: "chef",
    description: "Triggers when a chef Blockchain event is initiated.",
  },
