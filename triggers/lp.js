...
const driver_id = "lp";
const lp_hidden = require("./lp_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (lp.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (lp.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  display: {
    label: "LP",
    description: "Triggers when a LP Blockchain event is initiated.",
  },
