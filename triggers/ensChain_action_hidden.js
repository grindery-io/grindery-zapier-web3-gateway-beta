...
const perform = async (z, bundle) => {
  ...
  try {
    ...
    z.console.log(
      "Auth Error in List Driver Actions Trigger (ensChain_hidden.js)",
      error.message
    );
...
module.exports = {
  ...
  key: "ensChain_action_hidden",
  noun: "EnsChain Actions",

  display: {
    label: "EnsChain Actions",
    description: "Triggers new EnsChain events.",
    hidden: true,
  },
