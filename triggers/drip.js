...
const drip_hidden = require("./drip_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (drip.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (drip.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  display: {
    label: "drip",
    description: "Triggers when a drip Blockchain event is initiated.",
  },
