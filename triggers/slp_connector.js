...
const driver_id = "slp_connector";
const slp_connector_hidden = require("./slp_connector_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (slp_connector.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (slp_connector.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  key: "slp_connector",
  noun: "Slp_connector Token",

  display: {
    label: "SLP Connector",
    description: "Triggers when a SLP Connector Blockchain event is initiated.",
  },
  ...
  operation: {
    ...
    inputFields: [
      ...
      },
      {
        ...
        dynamic: "slp_connector_hidden.key",
      },
