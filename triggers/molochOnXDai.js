...
const molochOnXDai_hidden = require("./molochOnXDai_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (molochOnXDai.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (molochOnXDai.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  key: "molochOnXDai",
  noun: "MolochOnXDai Token",

  display: {
    label: "MolochOnXDai",
    description: "Triggers when MolochOnXDai Blockchain event occurs.",
  },
  ...
  operation: {
    ...
    inputFields: [
      ...
      },
      {
        ...
        dynamic: "molochOnXDai_hidden.key",
      },
