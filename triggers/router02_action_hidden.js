...
const perform = async (z, bundle) => {
  ...
  try {
    ...
    z.console.log(
      "Auth Error in List Driver Actions Trigger (router02_hidden.js)",
      error.message
    );
...
module.exports = {
  ...
  key: "router02_action_hidden",
  noun: "Router02 Actions",

  display: {
    label: "Router02 Actions",
    description: "Triggers new Router02 events.",
    hidden: true,
  },
