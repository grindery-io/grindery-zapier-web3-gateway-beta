...
const perform = async (z, bundle) => {
  ...
  try {
    ...
    z.console.log(
      "Auth Error in List Driver Actions Trigger (marketplace_hidden.js)",
      error.message
    );
...
module.exports = {
  ...
  key: "marketplace_action_hidden",
  noun: "Marketplace Actions",

  display: {
    label: "Marketplace Actions",
    description: "Triggers new Marketplace events.",
    hidden: true,
  },
