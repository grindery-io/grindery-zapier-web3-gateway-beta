...
const router_hidden = require("./router_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (router.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (router.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  display: {
    label: "router",
    description: "Triggers when a router Blockchain event is initiated.",
  },
