...
const candy_chef_hidden = require("./candy_chef_hidden");
...
const creatorID = async (z, bundle) => {
  try {
    ...
    if (error.message === "Invalid access token") {
      z.console.log(
        "Auth Error in creatorID function (candy_chef.js)",
        error.message
      );
      throw new z.errors.RefreshAuthError();
    } else {
      z.console.log(
        "Error in creatorID function (candy_chef.js)",
        error.message
      );
    }
  }
...
module.exports = {
  ...
  key: "candy_chef",
  noun: "Candy_chef Token",

  display: {
    label: "candy chef",
    description: "Triggers when a candy chef Blockchain event is initiated.",
  },
