...
const driver_id = "quickswap_router";
const quickswap_router_action_hidden = require("../triggers/quickswap_router_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("quickswap-router");
...
module.exports = {
  ...
  key: "quickswap_router",
  noun: "Quickswap_router",

  display: {
    label: "quickswap router",
    description: "Configure actions using quickswap router directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "quickswap_router_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("quickswap-router");
