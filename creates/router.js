...
const driver_id = "router";
const router_action_hidden = require("../triggers/router_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("router");
...
module.exports = {
  ...
  display: {
    label: "router",
    description: "Configure actions using router directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "router_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("router");
