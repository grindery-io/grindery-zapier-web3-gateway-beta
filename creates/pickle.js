...
const pickle_action_hidden = require("../triggers/pickle_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("pickle");
...
module.exports = {
  ...
  display: {
    label: "pickle",
    description: "Configure actions using pickle directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "pickle_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("pickle");
