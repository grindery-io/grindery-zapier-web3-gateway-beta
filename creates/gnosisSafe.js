...
const gnosisSafe_action_hidden = require("../triggers/gnosisSafe_action_hidden");
...
module.exports = {
  ...
  display: {
    label: "Gnosis Safe",
    description: "Configure actions using Gnosis Safe directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "gnosisSafe_action_hidden.key",
      },
