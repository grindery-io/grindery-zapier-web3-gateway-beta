...
const driver_id = "drip";
const drip_action_hidden = require("../triggers/drip_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("drip");
...
module.exports = {
  ...
  display: {
    label: "drip",
    description: "Configure actions using drip directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "drip_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("drip");
