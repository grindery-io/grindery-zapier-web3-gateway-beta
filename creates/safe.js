...
const driver_id = "safe";
const safe_action_hidden = require("../triggers/safe_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("safe");
...
module.exports = {
  ...
  display: {
    label: "Safe",
    description: "Configure actions using Safe directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "safe_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("safe");
