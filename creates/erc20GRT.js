...
const driver_id = "erc20GRT";
const erc20GRT_action_hidden = require("../triggers/erc20GRT_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("erc20GRT");
...
module.exports = {
  ...
  display: {
    label: "GRT ERC20 Token on Goerli chain",
    description: "Configure actions using GRT ERC20 Token on Goerli chain directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "erc20GRT_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("erc20GRT");
