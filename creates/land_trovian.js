...
const land_trovian_action_hidden = require("../triggers/land_trovian_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("land-trovian");
...
module.exports = {
  ...
  display: {
    label: "LAND Trovian",
    description: "Configure actions using LAND Trovian directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "land_trovian_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("land-trovian");
