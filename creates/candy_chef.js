...
const driver_id = "candy_chef";
const candy_chef_action_hidden = require("../triggers/candy_chef_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("candy-chef");
...
module.exports = {
  ...
  display: {
    label: "candy chef",
    description: "Configure actions using candy chef directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "candy_chef_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("candy-chef");
