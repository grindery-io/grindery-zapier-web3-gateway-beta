...
const driver_id = "molochOnXDai";
const molochOnXDai_action_hidden = require("../triggers/molochOnXDai_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("molochOnXDai");
...
module.exports = {
  ...
  display: {
    label: "MolochOnXDai Actions",
    description: "Configure actions using molochOnXDai directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "molochOnXDai_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("molochOnXDai");
