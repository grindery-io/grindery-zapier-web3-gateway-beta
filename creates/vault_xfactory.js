...
const driver_id = "vault_xfactory";
const vault_xfactory_action_hidden = require("../triggers/vault_xfactory_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("vault-xfactory");
...
module.exports = {
  ...
  display: {
    label: "vault xfactory",
    description: "Configure actions using vault xfactory directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "vault_xfactory_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("vault-xfactory");
