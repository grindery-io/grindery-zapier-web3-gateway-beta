...
const driver_id = "algorand";
const algorand_action_hidden = require("../triggers/algorand_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("algorand");
    ...
    inputFields: [
      {
        ...
        dynamic: "algorand_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("algorand");
