...
const driver_id = "messages";
const messages_action_hidden = require("../triggers/messages_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("messages");
...
module.exports = {
  ...
  display: {
    label: "messages",
    description: "Configure actions using messages directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "messages_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("messages");
