...
const driver_id = "marketplace";
const marketplace_action_hidden = require("../triggers/marketplace_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("marketplace");
...
module.exports = {
  ...
  display: {
    label: "marketplace",
    description: "Configure actions using marketplace directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "marketplace_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("marketplace");
