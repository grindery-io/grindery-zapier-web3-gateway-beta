...
const driver_id = "flash";
const flash_action_hidden = require("../triggers/flash_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("flash");
...
module.exports = {
  ...
  display: {
    label: "flash",
    description: "Configure actions using flash directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "flash_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("flash");
