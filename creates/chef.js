...
const driver_id = "chef";
const chef_action_hidden = require("../triggers/chef_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("chef");
...
module.exports = {
  ...
  display: {
    label: "chef",
    description: "Configure actions using chef directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "chef_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("chef");
