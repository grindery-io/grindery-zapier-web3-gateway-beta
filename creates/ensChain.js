...
const driver_id = "ensChain";
const ensChain_action_hidden = require("../triggers/ensChain_action_hidden");
...
const perform = async (z, bundle) => {
  ...
  try {
    //Get the driver
    let selected_driver_response = await client.getDriver("ensChain");
...
module.exports = {
  ...
  display: {
    label: "ENSCHAIN",
    description: "Configure actions using ensChain directly in Zapier.",
  },
    ...
    inputFields: [
      {
        ...
        dynamic: "ensChain_action_hidden.key",
      },
      async function (z, bundle) {
        const client = new NexusClient();
        try {
          let response = await client.getDriver("ensChain");
